...
Θα μετονομάσω λοιπόν το υπουργείο σε "Υπουργείο Παιδείας μέσω Διδασκαλίας". Γιατί ως υπουργός, το μόνο που μπορώ να ελέγξω και να εγγυηθώ για την ποιότητα της, είναι αυτή η Διδασκαλία. Ελπίζοντας έτσι κάποιοι να συνειδητοποιήσουν πως η Παιδεία είναι κοινός παρονομαστής σε κάθε είδους και μορφή διδασκαλία.
